...
#End Region
    ...
    Private Sub Panel_ChiTietTuyen_Click(sender As Object, e As EventArgs) Handles Panel_ChiTietTuyen.Click

    End Sub

    Private Sub luoi_Thoi_diem_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles luoi_Thoi_diem.CellContentClick
